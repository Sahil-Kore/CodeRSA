...
if __name__ == "__main__":
    ...
    out_path = "results/upiter-tiny_code-400M/eval.jsonl"
    os.makedirs("results/upiter-tiny_code-400M", exist_ok=True)

    tokenizer = AutoTokenizer.from_pretrained("upiter/TinyCodeLM-400M")
