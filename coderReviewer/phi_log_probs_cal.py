...
if __name__ == "__main__":
    ...
    file_path = f"./instructions/phi/{args.input_file}.jsonl"
    ...
    os.makedirs("./instructions/phi/probabilities", exist_ok=True)

    output_path = f"./instructions/phi/probabilities/{args.input_file}.jsonl"
