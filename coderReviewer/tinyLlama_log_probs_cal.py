...
if __name__ == "__main__":
    ...
    file_path = f"./instructions/tinyLlama/{args.input_file}.jsonl"
    ...
    os.makedirs("./instructions/tinyLlama/probabilities",exist_ok= True)
    

    output_path = f"./instructions/tinyLlama/probabilities/{args.input_file}.jsonl"
